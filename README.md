...
Current source version: **0.3.35** (`versionCode 43`).
...
## Included in version 0.3.35
- Formatted plug-in backup sizes in B, kB or MB instead of displaying a raw byte count.
- Localized backup commands and Venetian Blind Open, Stop and Close commands through application XML resources.
- Increased the Android package version to `0.3.35` (`versionCode 43`).
